...
def get_device_schema() -> pa.Schema:
    ...
    return pa.schema(
        [
            ...
            pa.field("boot_uid", pa.string(), nullable=True),
            ...
            pa.field("eid", pa.string(), nullable=True),
            ...
            pa.field("iccid", pa.string(), nullable=True),
            ...
            pa.field("is_mobile_account_active", pa.bool8(), nullable=True),
            pa.field("is_personal", pa.bool8(), nullable=True),
            pa.field("is_shared", pa.bool8(), nullable=True),
            pa.field("is_supervised", pa.bool8(), nullable=True),
            ...
            pa.field("meid", pa.string(), nullable=True),
            ...
            pa.field("udid", pa.string(), nullable=True),
