"""Auto-generated Arrow schema for OCSF class 'application_error'.
...
def get_application_error_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'application_error'."""
    return pa.schema(
        [
