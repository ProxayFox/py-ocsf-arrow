"""Auto-generated Arrow schema for OCSF class 'session_query'.
...
def get_session_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'session_query'."""
    return pa.schema(
        [
            ...
            pa.field("session", pa.struct(list(SESSION_SCHEMA)), nullable=False),
