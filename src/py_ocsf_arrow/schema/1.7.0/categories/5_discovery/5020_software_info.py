"""Auto-generated Arrow schema for OCSF class 'software_info'.
...
def get_software_info_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'software_info'."""
    return pa.schema(
        [
            ...
            pa.field("package", pa.struct(list(PACKAGE_SCHEMA)), nullable=True),
