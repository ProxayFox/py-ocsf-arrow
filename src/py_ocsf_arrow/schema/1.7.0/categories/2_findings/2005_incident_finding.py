...
def get_incident_finding_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'incident_finding'."""
    return pa.schema(
        [
            ...
            pa.field(
                "finding_info_list",
                pa.list_(pa.struct(list(FINDING_INFO_SCHEMA))),
                nullable=False,
            ),
            pa.field(
                "firewall_rule",
            ...
            pa.field("status_id", pa.int32(), nullable=False),
