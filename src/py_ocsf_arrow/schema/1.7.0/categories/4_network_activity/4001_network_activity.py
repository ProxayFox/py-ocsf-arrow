"""Auto-generated Arrow schema for OCSF class 'network_activity'.
...
def get_network_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'network_activity'."""
    return pa.schema(
        [
            ...
            pa.field("is_src_dst_assignment_known", pa.bool8(), nullable=True),
            pa.field(
