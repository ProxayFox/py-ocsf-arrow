"""Auto-generated Arrow schema for OCSF class 'ssh_activity'.
...
HASSH_SCHEMA = _load_dep("hassh").HASSH_SCHEMA
...
def get_ssh_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'ssh_activity'."""
    return pa.schema(
        [
            ...
            pa.field("auth_type", pa.string(), nullable=True),
            pa.field("auth_type_id", pa.int32(), nullable=True),
            pa.field(
                "authorizations",
            ...
            pa.field("client_hassh", pa.struct(list(HASSH_SCHEMA)), nullable=True),
            ...
            pa.field("server_hassh", pa.struct(list(HASSH_SCHEMA)), nullable=True),
