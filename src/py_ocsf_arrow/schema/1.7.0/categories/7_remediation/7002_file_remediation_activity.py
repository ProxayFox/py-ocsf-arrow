"""Auto-generated Arrow schema for OCSF class 'file_remediation_activity'.
...
def get_file_remediation_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'file_remediation_activity'."""
    return pa.schema(
        [
