"""Auto-generated Arrow schema for OCSF class 'script_activity'.
...
def get_script_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'script_activity'."""
    return pa.schema(
        [
            ...
            pa.field("script", pa.struct(list(SCRIPT_SCHEMA)), nullable=False),
