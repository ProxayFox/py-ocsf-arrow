"""Auto-generated Arrow schema for OCSF class 'kernel_extension_activity'.
...
def get_kernel_extension_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'kernel_extension_activity'."""
    return pa.schema(
        [
            ...
            pa.field("driver", pa.struct(list(KERNEL_DRIVER_SCHEMA)), nullable=False),
