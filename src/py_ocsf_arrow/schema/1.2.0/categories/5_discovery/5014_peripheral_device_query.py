"""Auto-generated Arrow schema for OCSF class 'peripheral_device_query'.
...
def get_peripheral_device_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'peripheral_device_query'."""
    return pa.schema(
        [
