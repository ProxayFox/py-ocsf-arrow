"""Auto-generated Arrow schema for OCSF class 'email_file_activity'.
...
def get_email_file_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'email_file_activity'."""
    return pa.schema(
        [
