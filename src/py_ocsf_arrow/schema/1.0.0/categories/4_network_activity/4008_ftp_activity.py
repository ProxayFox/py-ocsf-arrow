"""Auto-generated Arrow schema for OCSF class 'ftp_activity'.
...
def get_ftp_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'ftp_activity'."""
    return pa.schema(
        [
            ...
            pa.field("codes", pa.list_(pa.int32()), nullable=True),
            pa.field("command", pa.string(), nullable=True),
            pa.field("command_responses", pa.list_(pa.string()), nullable=True),
            pa.field(
                "connection_info",
