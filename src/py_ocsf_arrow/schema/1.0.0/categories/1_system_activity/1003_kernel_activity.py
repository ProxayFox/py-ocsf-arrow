"""Auto-generated Arrow schema for OCSF class 'kernel_activity'.
...
def get_kernel_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'kernel_activity'."""
    return pa.schema(
        [
            ...
            pa.field("kernel", pa.struct(list(KERNEL_SCHEMA)), nullable=False),
            pa.field(
                "malware",
