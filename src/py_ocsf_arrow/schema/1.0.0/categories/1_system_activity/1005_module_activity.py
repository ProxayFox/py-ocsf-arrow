"""Auto-generated Arrow schema for OCSF class 'module_activity'.
...
def get_module_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'module_activity'."""
    return pa.schema(
        [
            ...
            pa.field("module", pa.struct(list(MODULE_SCHEMA)), nullable=False),
            pa.field(
                "observables",
