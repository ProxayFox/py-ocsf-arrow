"""Auto-generated Arrow schema for OCSF class 'kernel_extension'.
...
def get_kernel_extension_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'kernel_extension'."""
    return pa.schema(
        [
