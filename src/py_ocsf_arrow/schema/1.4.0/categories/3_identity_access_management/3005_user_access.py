"""Auto-generated Arrow schema for OCSF class 'user_access'.
...
def get_user_access_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'user_access'."""
    return pa.schema(
        [
            ...
            pa.field("privileges", pa.list_(pa.string()), nullable=False),
