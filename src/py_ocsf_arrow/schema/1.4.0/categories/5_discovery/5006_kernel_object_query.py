"""Auto-generated Arrow schema for OCSF class 'kernel_object_query'.
...
def get_kernel_object_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'kernel_object_query'."""
    return pa.schema(
        [
