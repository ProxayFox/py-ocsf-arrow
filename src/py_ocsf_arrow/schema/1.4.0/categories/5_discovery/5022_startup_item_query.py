"""Auto-generated Arrow schema for OCSF class 'startup_item_query'.
...
def get_startup_item_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'startup_item_query'."""
    return pa.schema(
        [
            ...
            pa.field(
                "startup_item", pa.struct(list(STARTUP_ITEM_SCHEMA)), nullable=False
            ),
