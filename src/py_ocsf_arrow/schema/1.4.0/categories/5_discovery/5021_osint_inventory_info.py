"""Auto-generated Arrow schema for OCSF class 'osint_inventory_info'.
...
def get_osint_inventory_info_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'osint_inventory_info'."""
    return pa.schema(
        [
