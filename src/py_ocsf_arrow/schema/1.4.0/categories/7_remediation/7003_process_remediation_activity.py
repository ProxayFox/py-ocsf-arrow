"""Auto-generated Arrow schema for OCSF class 'process_remediation_activity'.
...
def get_process_remediation_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'process_remediation_activity'."""
    return pa.schema(
        [
