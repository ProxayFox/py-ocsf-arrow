"""Auto-generated Arrow schema for OCSF class 'ntp_activity'.
...
def get_ntp_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'ntp_activity'."""
    return pa.schema(
        [
            ...
            pa.field("dispersion", pa.int32(), nullable=True),
            ...
            pa.field("precision", pa.int32(), nullable=True),
            ...
            pa.field("stratum_id", pa.int32(), nullable=True),
