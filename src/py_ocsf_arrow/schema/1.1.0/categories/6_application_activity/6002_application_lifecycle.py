"""Auto-generated Arrow schema for OCSF class 'application_lifecycle'.
...
def get_application_lifecycle_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'application_lifecycle'."""
    return pa.schema(
        [
            ...
            pa.field("app", pa.struct(list(PRODUCT_SCHEMA)), nullable=False),
