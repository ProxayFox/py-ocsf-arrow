"""Auto-generated Arrow schema for OCSF object 'data_classification'.
...
def get_data_classification_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF object 'data_classification'."""
    return pa.schema(
        [
...
DATA_CLASSIFICATION_SCHEMA = get_data_classification_schema()
