"""Auto-generated Arrow schema for OCSF class 'detection_finding'.
...
ANOMALY_ANALYSIS_SCHEMA = _load_dep("anomaly_analysis").ANOMALY_ANALYSIS_SCHEMA
ENRICHMENT_SCHEMA = _load_dep("enrichment").ENRICHMENT_SCHEMA
EVIDENCES_SCHEMA = _load_dep("evidences").EVIDENCES_SCHEMA
...
def get_detection_finding_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'detection_finding'."""
    return pa.schema(
        [
            ...
            pa.field(
                "anomaly_analyses",
                pa.list_(pa.struct(list(ANOMALY_ANALYSIS_SCHEMA))),
                nullable=True,
            ),
            ...
            pa.field(
                "evidences", pa.list_(pa.struct(list(EVIDENCES_SCHEMA))), nullable=True
            ),
            pa.field(
