"""Auto-generated Arrow schema for OCSF class 'scan_activity'.
...
def get_scan_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'scan_activity'."""
    return pa.schema(
        [
            ...
            pa.field("command_uid", pa.string(), nullable=True),
            ...
            pa.field("num_detections", pa.int32(), nullable=True),
            pa.field("num_files", pa.int32(), nullable=True),
            pa.field("num_folders", pa.int32(), nullable=True),
            pa.field("num_network_items", pa.int32(), nullable=True),
            pa.field("num_processes", pa.int32(), nullable=True),
            pa.field("num_registry_items", pa.int32(), nullable=True),
            pa.field("num_resolutions", pa.int32(), nullable=True),
            pa.field("num_skipped_items", pa.int32(), nullable=True),
            pa.field("num_trusted_items", pa.int32(), nullable=True),
            pa.field(
                "observables",
            ...
            pa.field("scan", pa.struct(list(SCAN_SCHEMA)), nullable=False),
            pa.field("schedule_uid", pa.string(), nullable=True),
