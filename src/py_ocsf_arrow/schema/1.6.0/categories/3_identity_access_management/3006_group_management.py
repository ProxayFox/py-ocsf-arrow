...
def get_group_management_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'group_management'."""
    return pa.schema(
        [
            ...
            pa.field("subgroup", pa.struct(list(GROUP_SCHEMA)), nullable=True),
