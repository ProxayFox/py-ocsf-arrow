"""Auto-generated Arrow schema for OCSF class 'folder_query'.
...
def get_folder_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'folder_query'."""
    return pa.schema(
        [
            ...
            pa.field("folder", pa.struct(list(FILE_SCHEMA)), nullable=False),
