"""Auto-generated Arrow schema for OCSF class 'http_activity'.
...
HTTP_COOKIE_SCHEMA = _load_dep("http_cookie").HTTP_COOKIE_SCHEMA
...
def get_http_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'http_activity'."""
    return pa.schema(
        [
            ...
            pa.field(
                "http_cookies",
                pa.list_(pa.struct(list(HTTP_COOKIE_SCHEMA))),
                nullable=True,
            ),
            pa.field(
                "http_request",
