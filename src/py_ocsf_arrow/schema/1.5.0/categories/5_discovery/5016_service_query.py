"""Auto-generated Arrow schema for OCSF class 'service_query'.
...
def get_service_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'service_query'."""
    return pa.schema(
        [
            ...
            pa.field("service", pa.struct(list(SERVICE_SCHEMA)), nullable=False),
