"""Auto-generated Arrow schema for OCSF class 'dhcp_activity'.
...
def get_dhcp_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'dhcp_activity'."""
    return pa.schema(
        [
            ...
            pa.field("is_renewal", pa.bool8(), nullable=True),
            pa.field(
                "ja4_fingerprint_list",
                pa.list_(pa.struct(list(JA4_FINGERPRINT_SCHEMA))),
                nullable=True,
            ),
            pa.field("lease_dur", pa.int32(), nullable=True),
            pa.field(
                "load_balancer",
            ...
            pa.field("relay", pa.struct(list(NETWORK_INTERFACE_SCHEMA)), nullable=True),
            ...
            pa.field("transaction_uid", pa.string(), nullable=True),
