"""Auto-generated Arrow schema for OCSF class 'remediation_activity'.
...
def get_remediation_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'remediation_activity'."""
    return pa.schema(
        [
