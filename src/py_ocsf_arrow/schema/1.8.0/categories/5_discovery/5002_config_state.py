"""Auto-generated Arrow schema for OCSF class 'config_state'.
...
def get_config_state_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'config_state'."""
    return pa.schema(
        [
            ...
            pa.field(
                "assessments",
                pa.list_(pa.struct(list(ASSESSMENT_SCHEMA))),
                nullable=True,
            ),
            pa.field(
                "attacks",
            ...
            pa.field(
                "cis_benchmark_result",
                pa.struct(list(CIS_BENCHMARK_RESULT_SCHEMA)),
                nullable=True,
            ),
