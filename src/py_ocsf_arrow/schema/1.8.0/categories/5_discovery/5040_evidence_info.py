"""Auto-generated Arrow schema for OCSF class 'evidence_info'.
...
QUERY_EVIDENCE_SCHEMA = _load_dep("query_evidence").QUERY_EVIDENCE_SCHEMA
QUERY_INFO_SCHEMA = _load_dep("query_info").QUERY_INFO_SCHEMA


def get_evidence_info_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'evidence_info'."""
    return pa.schema(
        [
            ...
            pa.field(
                "query_evidence",
                pa.struct(list(QUERY_EVIDENCE_SCHEMA)),
                nullable=False,
            ),
