"""Auto-generated Arrow schema for OCSF class 'admin_group_query'.
...
def get_admin_group_query_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'admin_group_query'."""
    return pa.schema(
        [
