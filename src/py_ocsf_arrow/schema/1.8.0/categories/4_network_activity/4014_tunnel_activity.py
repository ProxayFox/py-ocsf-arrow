"""Auto-generated Arrow schema for OCSF class 'tunnel_activity'.
...
def get_tunnel_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'tunnel_activity'."""
    return pa.schema(
        [
            ...
            pa.field(
                "tunnel_interface",
                pa.struct(list(NETWORK_INTERFACE_SCHEMA)),
                nullable=True,
            ),
            pa.field("tunnel_type", pa.string(), nullable=True),
            pa.field("tunnel_type_id", pa.int32(), nullable=True),
