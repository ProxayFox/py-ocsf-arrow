"""Auto-generated Arrow schema for OCSF class 'drone_flights_activity'.
...
).UNMANNED_AERIAL_SYSTEM_SCHEMA
UNMANNED_SYSTEM_OPERATING_AREA_SCHEMA = _load_dep(
    "unmanned_system_operating_area"
).UNMANNED_SYSTEM_OPERATING_AREA_SCHEMA
USER_SCHEMA = _load_dep("user").USER_SCHEMA


def get_drone_flights_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'drone_flights_activity'."""
    return pa.schema(
        [
            ...
            pa.field(
                "unmanned_aerial_system",
                pa.struct(list(UNMANNED_AERIAL_SYSTEM_SCHEMA)),
                nullable=False,
            ),
            pa.field(
                "unmanned_system_operating_area",
                pa.struct(list(UNMANNED_SYSTEM_OPERATING_AREA_SCHEMA)),
                nullable=True,
            ),
            pa.field(
