"""Auto-generated Arrow schema for OCSF class 'peripheral_activity'.
...
def get_peripheral_activity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'peripheral_activity'."""
    return pa.schema(
        [
