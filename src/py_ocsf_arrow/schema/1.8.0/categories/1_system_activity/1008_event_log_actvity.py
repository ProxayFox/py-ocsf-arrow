"""Auto-generated Arrow schema for OCSF class 'event_log_actvity'.
...
def get_event_log_actvity_schema() -> pa.Schema:
    """Return the Arrow schema for OCSF class 'event_log_actvity'."""
    return pa.schema(
        [
            ...
            pa.field("log_type", pa.string(), nullable=True),
            pa.field("log_type_id", pa.int32(), nullable=True),
