...
TRACE_SCHEMA = _load_dep("trace").TRACE_SCHEMA
...
def get_api_activity_schema() -> pa.Schema:
    ...
    return pa.schema(
        [
            ...
            pa.field("api", pa.struct(list(API_SCHEMA)), nullable=False),
            pa.field(
                "attacks",
            ...
            pa.field("trace", pa.struct(list(TRACE_SCHEMA)), nullable=True),
