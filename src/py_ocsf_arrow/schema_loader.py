...
class SchemaLoader:
    ...
    >>> loader.available_classes()[:3]
    ['...']
    >>> loader.available_objects()[:3]
    ['...']
...
def load_class_schema(class_name: str, version: str = "default") -> pa.Schema:
    ...
    """
    return SchemaLoader(version).load_class(class_name)
